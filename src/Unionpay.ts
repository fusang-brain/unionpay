...
import { setMode, Mode } from './ConfigInstance'
...
export default class Unionpay {
  ...
  constructor(option: UnionpayConfig, mode?: ConfigMode) {
    ...
    const parsedPem = CertUtil.parseSignedDataFromPfx(this.option.acpsdk.signCert.path, this.option.acpsdk.signCert.pwd)
